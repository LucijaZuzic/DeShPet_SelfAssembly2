...
# Save features
np.save(DATA_PATH + 'amino_acids_NEW1.npy', np.array(feature_dict_1)) 
np.save(DATA_PATH + 'amino_acids_NEW2.npy', np.array(feature_dict_2)) 
np.save(DATA_PATH + 'amino_acids_NEW3.npy', np.array(feature_dict_1)) 
