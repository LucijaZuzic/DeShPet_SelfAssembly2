...
from utils import set_seed, results_name, log_name, basic_dir, DATA_PATH, AP_DATA_PATH, SP_DATA_PATH, AP_SP_DATA_PATH, TSNE_SP_DATA_PATH, TSNE_AP_SP_DATA_PATH

seed_list = [305475974, 369953070, 879273778, 965681145, 992391276] 
paths = [AP_DATA_PATH, SP_DATA_PATH, AP_SP_DATA_PATH, TSNE_SP_DATA_PATH, TSNE_AP_SP_DATA_PATH] 
...
for some_seed in seed_list:
    ...
    for some_path in path_list:
        ...
        for train_and_validation_data_indices, test_data_indices in kfold_first.split(all_data, all_labels):
            ...
            other_output = open(results_name(some_path, test_number), "w", encoding = "utf-8") 
            other_output.write("")
            other_output.close()
            ...
            basic_training(some_path, test_number, train_and_validation_data, train_and_validation_labels, kfold_second, EPOCHS, factor_NSA, test_data, test_labels, names, offset, properties, masking_value, used_thr)
