...
for some_path in path_list:
    ...
    sys.stdout = open(
        final_log_name(some_path).replace("final", "final_no"), "w", encoding="utf-8"
    )
    ...
    other_output = open(
        seed_res_name(some_path).replace("final", "final_no"), "w", encoding="utf-8"
    )
    other_output.write(
    ...
    other_output = open(
        seed_acc_txt_name(some_path).replace("final", "final_no"), "w", encoding="utf-8"
    )
    ...
    other_output = open(
        seed_loss_txt_name(some_path).replace("final", "final_no"),
        "w",
        encoding="utf-8",
    )
    ...
    plt.title("Final model no human no AI " + PATH_TO_NAME[some_path] + "\n Accuracy")
    plt.ylabel("Accuracy")
    plt.xlabel("Epoch")
    plt.legend(loc="upper center", bbox_to_anchor=(0.5, -0.1), ncol=2)
    plt.savefig(
        seed_acc_png_name(some_path).replace("final", "final_no"), bbox_inches="tight"
    )
    plt.close()
    ...
    plt.legend(loc="upper center", bbox_to_anchor=(0.5, -0.1), ncol=2)
    plt.savefig(
        seed_loss_png_name(some_path).replace("final", "final_no"), bbox_inches="tight"
    )
    plt.close()
