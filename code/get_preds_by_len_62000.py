...
df = pd.read_csv("../data/collection_of_peptide_data.csv")
...
def filter_dict(minlen, maxlen):
    ...
    for model_name in os.listdir("../final"):
        ...
        pred_file = open("../final/" + model_name + "/" + short_model + "_predictions_longest.txt", "r")
        ...
        if not os.path.isdir("review_62000/long/preds/" + str(minlen) + "_" + str(maxlen)+ "/" + model_name):
            os.makedirs("review_62000/long/preds/" + str(minlen) + "_" + str(maxlen) + "/" + model_name)
        ...
        df_newPR.to_csv("review_62000/long/preds/" + str(minlen) + "_" + str(maxlen) + "/" + model_name + "/" + str(minlen) + "_" + str(maxlen) + "_" + model_name + "_PR_preds.csv")
        df_newROC.to_csv("review_62000/long/preds/" + str(minlen) + "_" + str(maxlen) + "/" + model_name + "/" + str(minlen) + "_" + str(maxlen) + "_" + model_name + "_ROC_preds.csv")
        df_new50.to_csv("review_62000/long/preds/" + str(minlen) + "_" + str(maxlen) + "/" + model_name + "/" + str(minlen) + "_" + str(maxlen) + "_" + model_name + "_50_preds.csv")
...
def print_dict(mini, maxi):
    ...
    for metric in dicti["AP"]:
        ...
        #print(linea + " \\\\ \\hline")
    if not os.path.isdir("review_62000/short"):
        os.makedirs("review_62000/short")
    df_new = pd.DataFrame(dict_csv_data)
    df_new.to_csv("review_62000/short/" + str(mini) + "_" + str(maxi) + ".csv")
