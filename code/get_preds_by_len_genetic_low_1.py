...
new = pd.read_csv("text_low_1.csv")["Feature"]
dict_hex = {}
ix_to_skip = []
peps_skipped = []
ix = 0
...
def filter_dict(minlen, maxlen):
    ...
    for model_name in os.listdir("../final"):
        ...
        if not os.path.isdir("review_genetic_low_1/long/preds/" + str(minlen) + "_" + str(maxlen)+ "/" + model_name):
            os.makedirs("review_genetic_low_1/long/preds/" + str(minlen) + "_" + str(maxlen) + "/" + model_name)
        ...
        df_newPR.to_csv("review_genetic_low_1/long/preds/" + str(minlen) + "_" + str(maxlen) + "/" + model_name + "/" + str(minlen) + "_" + str(maxlen) + "_" + model_name + "_PR_preds.csv")
        df_newROC.to_csv("review_genetic_low_1/long/preds/" + str(minlen) + "_" + str(maxlen) + "/" + model_name + "/" + str(minlen) + "_" + str(maxlen) + "_" + model_name + "_ROC_preds.csv")
        df_new50.to_csv("review_genetic_low_1/long/preds/" + str(minlen) + "_" + str(maxlen) + "/" + model_name + "/" + str(minlen) + "_" + str(maxlen) + "_" + model_name + "_50_preds.csv")
...
def print_dict(mini, maxi):
    ...
    for metric in dicti["AP"]:
        ...
        #print(linea + " \\\\ \\hline")
    if not os.path.isdir("review_genetic_low_1/short"):
        os.makedirs("review_genetic_low_1/short")
    df_new = pd.DataFrame(dict_csv_data)
    df_new.to_csv("review_genetic_low_1/short/" + str(mini) + "_" + str(maxi) + ".csv")
