from utils import set_seed, predictions_name, final_history_name, PATH_TO_EXTENSION, AP_DATA_PATH, SP_DATA_PATH, AP_SP_DATA_PATH, TSNE_SP_DATA_PATH, TSNE_AP_SP_DATA_PATH
from custom_plots import merge_type_test_number, results_name,my_accuracy_calculate, weird_division, convert_to_binary
...
def hist_predicted_multiple(
    ...
    plt.figure()
    plt.title(
        merge_type_test_number(model_type, test_number).replace("Test 0 Weak 1", "All tests")
