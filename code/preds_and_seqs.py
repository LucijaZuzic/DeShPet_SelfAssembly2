from utils import PATH_TO_NAME, predictions_name, DATA_PATH, AP_DATA_PATH, SP_DATA_PATH, AP_SP_DATA_PATH, TSNE_SP_DATA_PATH, TSNE_AP_SP_DATA_PATH, set_seed, PATH_TO_EXTENSION
...
for some_path in paths:
    ...
    dict_some[PATH_TO_NAME[some_path]] = {'sequences': all_seqs, 'labels': all_labels_new, 'predictions': all_preds, 'seeds': all_seeds, 'model_types': all_model_types}
