...
def basic_dir(some_path, test_number): 
    return "../seeds/seed_" + str(get_seed()) + some_path.replace("..", "") + name_plus_test(some_path, test_number) + "/"
...
def predictions_thr_name(some_path, test_number, params_nr, fold_nr):        
    return basic_path(some_path, test_number) + "predictions" + params_plus_fold(params_nr, fold_nr) + ".txt"
